    ...
    <div id="quick-start" className="col-span-1 md:col-span-2 lg:col-span-3 bg-indigo-600 dark:bg-indigo-700 rounded-3xl p-6 shadow-bento text-white flex flex-col justify-between bento-card group">
      <div>
        <h3 className="text-xl font-bold mb-2 flex items-center">
          <i className="fas fa-link mr-2 opacity-70"></i> API Endpoint
        </h3>
        <p className="text-indigo-100 text-sm mb-6">兼容 OpenAI 格式，直接替换 Base URL 即可使用。</p>
      </div>
      ...
      >
        <code className="font-mono text-sm truncate mr-2">https://kfc-api.sxxe.net</code>
